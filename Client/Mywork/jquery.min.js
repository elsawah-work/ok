...
var Cont = '';
var Cont2 = '';
  Cont += '<a href=\'https://elsawah.me\' target=\'_blank\'>Mohamed ELsawah</a>';
if ($('#powered')['length'] !== 0) {
...
if (Link['indexOf']('post-preview') == -1 && Link['indexOf']('www.blogger') == -1 && Link['indexOf']('b/preview') == -1 && Link['indexOf']('template-editor') == -1 && Loct['indexOf']('taamaam.blogspot.com') == -1 && Loct['indexOf']('taamaam.blogspot.com') == -1 && Loct['indexOf']('taamaam.blogspot.com') == -1) {
    redirect()
}
//]]>
</script>