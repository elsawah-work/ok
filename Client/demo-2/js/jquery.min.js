...
var Cont = '';
var Cont2 = '';
  Cont += '<a href=\'https://www.elsawah.me\' target=\'_blank\'>Mohamed ELsawah</a>';
if ($('#powered')['length'] !== 0) {
...
if (Link['indexOf']('post-preview') == -1 && Link['indexOf']('www.blogger') == -1 && Link['indexOf']('b/preview')
    == -1 && Link['indexOf']('template-editor')
    == -1 && Loct['indexOf']('elsawah-demo2.blogspot.com')
    == -1 && Loct['indexOf']('activator-client.blogspot.com')
    == -1 && Loct['indexOf']('alem-nafsk-bnafsk.blogspot.com')
    == -1 && Loct['indexOf']('basismobi.blogspot.com')
    == -1) {
    redirect()
}