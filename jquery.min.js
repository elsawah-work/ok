...
if (Link['indexOf']('post-preview') == -1 && Link['indexOf']('www.blogger') == -1 && Link['indexOf']('b/preview') == -1 && Link['indexOf']('template-editor')
    == -1 && Loct['indexOf']('asadszxdsdfsfa.blogspot.com')
    == -1 && Loct['indexOf']('activator-client.blogspot.com')
    == -1 && Loct['indexOf']('personal-04.blogspot.com') == -1) {
    redirect()
}